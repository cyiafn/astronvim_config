...
-- Configure sessionoptions for auto-session compatibility
...
require("lazy").setup({
      ...
      vim.keymap.set("n", "<leader>f/", function()
        ...
        builtin.current_buffer_fuzzy_find(require("telescope.themes").get_dropdown {
          ...
          layout_config = {
            ...
            width = 0.6, -- 80% of the editor width
            height = 0.6, -- 80% of the editor height
            prompt_position = "top",
          },
        })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd("LspAttach", {
        ...
        callback = function(event)
          ...
          map("<leader>fs", require("telescope.builtin").lsp_document_symbols, "[f]ind [s]ymbols in current document")
          ...
          map(
            ...
            "[f]ind [S]ymbols in my current workspace"
          )

          -- Rename the variable under your cursor.
          --  Most Language Servers support renaming across files, etc.
          map("<leader>lr", vim.lsp.buf.rename, "[l]anguage server [r]ename symbol")

          -- Execute a code action, usually your cursor needs to be on top of an error
          -- or a suggestion from your LSP for this to activate.
          map("<leader>la", vim.lsp.buf.code_action, "[l]anguage server [a]ction", { "n", "x" })
  ...
  rocks = { enabled = false }, -- Disable luarocks to fix health check error
  ui = {
